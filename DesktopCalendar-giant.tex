...
%%%%%%
\illustration
[Calendário com Script em LaTeX, usando a IDE mais poderosa, chamado Overleaf]
{\linewidth}{tikzlings}
...
\otherstuff[Teoria de Resposta ao Item]
{\linewidth}
{\large\selectfon
\[%
...
\begin{monthCalendar}{2023}{02}

%% Repeat the event if it spans two months
\event[mark style=blue icon,marker=\faBriefcase]{2023-01-30}{5}{ACME Conference}
\event[mark style=pink icon,marker=\faBirthdayCake]{2023-02-07}{}{Someone's birthday}
\event{2023-02-24}{}{Grant proposal deadline!!}
...
\otherstuff{\linewidth}
  {\tikz[scale=5]\duck[witch=black!50!gray,
      ...
      magicwand];}
\begin{monthCalendar}{2023}{10}
\end{monthCalendar}

\clearpage

\otherstuff{\linewidth}
  {\tikz[scale=5]\duck[snowduck=white!90!gray,eye=white];}
\begin{monthCalendar}{2023}{11}
\end{monthCalendar}

\clearpage

\otherstuff{\linewidth}{\tikz[scale=5]\marmot[santa,wine];}
\begin{monthCalendar}{2023}{12}
\end{monthCalendar}
